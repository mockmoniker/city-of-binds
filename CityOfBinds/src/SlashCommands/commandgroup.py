...
class _CommandList:
    ...
    def _do_list_method(self, list_method_name: str, *args, command_string: str = None) -> Self:
    ...
    def _add_power_command(self, powexec_type: str, power_string: str, location_arg: str = None) -> Self:
    ...
    def _prepend_power_command(self, powexec_type: str, power_string: str, location_arg: str = None) -> Self:
        """Helper function to prepend a power command to the command group."""
        command_string = self._build_power_command_string(powexec_type, power_string, location_arg)
        return self.prepend_command(command_string)

    def _insert_power_command(self, index: int, powexec_type: str, power_string: str, location_arg: str = None) -> Self:
    ...
    def _add_bind_file_command(self, bind_file_command: str, bind_file_path: str) -> Self:
    ...
    def _prepend_bind_file_command(self, bind_file_command: str, bind_file_path: str) -> Self:
        """Helper function to prepend a bind file command to the command group."""
        command_string = self._build_bind_file_command_string(bind_file_command, bind_file_path)
        return self.prepend_command(command_string)
    
    def _insert_bind_file_command(self, index: int, bind_file_command: str, bind_file_path: str) -> Self:
