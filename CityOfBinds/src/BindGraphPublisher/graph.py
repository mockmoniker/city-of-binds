...
class BindFileGraph(nx.DiGraph):
    ...
    def make_k_regular(
        ...
        if k > len(bind_file_indexes):
            ...
            )  # TODO: add verify logic (2025/11/30)
    ...
    def _subdivide_edge(
        ...
        super().add_edge(
            source_bind_file_index, new_bind_file_index, **(first_condition or {})
        )
        super().add_edge(
            new_bind_file_index, target_bind_file_index, **(second_condition or {})
        )
