...
from scenarios.wasdbind_scenarios import WASDBindScenarios
...
class TestValidWASDBindInitializaiton(test_ToggleBind.TestValidToggleBindInitializaiton):
    ...
    @pytest.mark.parametrize("valid_trigger_input, expected_trigger_output", WASDBindScenarios.valid_set_wasd_trigger_scenarios)
    ...
    @pytest.mark.parametrize("valid_trigger_input, expected_direction_output", WASDBindScenarios.valid_set_wasd_direction_scenarios)
    ...
    #@pytest.mark.parametrize("valid_powers_input, expected_powers_output", WASDBindScenarios.valid_set_powers_scenarios)
...
class TestValidWASDBindSetters(test_ToggleBind.TestValidToggleBindSetters):
    ...
    @pytest.mark.parametrize("valid_trigger_input, expected_trigger_direciton", WASDBindScenarios.valid_set_wasd_direction_scenarios)
