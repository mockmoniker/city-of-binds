...
class TestCommentBannerInitialization:
    ...
    def test_init_should_set_internal_border_style_given_valid_border_style(self):
        ...
        valid_border_style = '-'
        # act
        comment_banner = self.COMMENT_BANNER_UNDER_TEST(comment_text=self.VALID_COMMENT_TEXT, border_style=valid_border_style)
        # assert
        assert comment_banner._border_style == '-'
...
class TestCommentBannerBorderStyleProperty:
    ...
    def test_border_style_getter_should_return_border_style(self):
        # arrange
        comment_banner = self.COMMENT_BANNER_UNDER_TEST(comment_text=self.VALID_COMMENT_TEXT, border_style='=')
    ...
    def test_border_style_setter_should_set_new_border_style_given_new_valid_border_style(self):
        # arrange
        comment_banner = self.COMMENT_BANNER_UNDER_TEST(comment_text=self.VALID_COMMENT_TEXT)
    ...
    def test_border_style_setter_should_raise_value_error_given_invalid_border_style(self):
        # arrange
        comment_banner = self.COMMENT_BANNER_UNDER_TEST(comment_text=self.VALID_COMMENT_TEXT, border_style='-')
