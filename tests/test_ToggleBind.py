...
from scenarios.bind_scenarios import BindScenarios

class TestValidToggleBindInitializaiton(test_Bind.TestValidBindInitializaiton):
    bind_under_test = ToggleBind
    default_trigger = "t"

    @pytest.mark.parametrize("valid_powers_input, expected_powers_output", BindScenarios.valid_set_powers_scenarios)
    ...
    @pytest.mark.parametrize("valid_power_input, expected_power_output", BindScenarios.valid_set_power_scenarios)
...
class TestInvalidToggleBindInitialization(test_Bind.TestInvalidBindInitialization):
    ...
    @pytest.mark.parametrize("invalid_powers_input, expected_error_message", BindScenarios.invalid_set_powers_scenarios)
    ...
    @pytest.mark.parametrize("invalid_power_input, expected_error_message", BindScenarios.invalid_set_power_scenarios)
