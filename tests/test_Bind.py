...
class TestValidBindInitializaiton:
    ...
    @pytest.mark.parametrize("valid_slash_commands_input, expected_slash_commands_output", BindScenarios.valid_set_slash_commands_scenarios)
...
class TestInvalidBindInitialization:
    ...
    @pytest.mark.parametrize("invalid_slash_commands_input, expected_error_message", BindScenarios.invalid_set_slash_commands_scenarios)
