...
class TestInitialization:
    ...
    def test_init_should_throw_error_given_command_string_with_too_many_spaces_between_command_and_args(self):
        # arrange
...
class TestValidSlashCommandInitialization:
    ...
    def test_init_should_set_args_to_empty_string_given_command_string_with_no_args(self):
        # arrange
        valid_command_string = 'forward'
        # act
        action = self.action_under_test(valid_command_string)
...
class TestInvalidSlashCommandInitialization:
    ...
    def test_init_should_raise_value_error_given_command_string_with_too_many_spaces(self):
        # arrange
