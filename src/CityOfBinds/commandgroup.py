...
class _CommandList:
    ...
    def add_power(self, power_string: str) -> '_CommandList':
    ...
    def add_toggle_on_power(self, power_string: str) -> '_CommandList':
    ...
    def add_toggle_off_power(self, power_string: str) -> '_CommandList':
    ...
    def add_auto_power(self, power_string: str) -> '_CommandList':
    ...
    def add_loc_self_power(self, power_string: str) -> '_CommandList':
    ...
    def add_loc_target_power(self, power_string: str) -> '_CommandList':
    ...
    def add_loc_cursor_power(self, power_string: str) -> '_CommandList':
    ...
    def prepend_power(self, power_string: str) -> '_CommandList':
        """Prepend a power as a slash command to the command group."""
        return self._prepend_power_command(CommandGroupConstants.POWEXEC_NAME, power_string)

    def prepend_toggle_on_power(self, power_string: str) -> '_CommandList':
        """Prepend a toggle on power as a slash command to the command group."""
        return self._prepend_power_command(CommandGroupConstants.POWEXEC_TOGGLE_ON, power_string)

    def prepend_toggle_off_power(self, power_string: str) -> '_CommandList':
        """Prepend a toggle off power as a slash command to the command group."""
        return self._prepend_power_command(CommandGroupConstants.POWEXEC_TOGGLE_OFF, power_string)

    def prepend_auto_power(self, power_string: str) -> '_CommandList':
        """Prepend an auto power as a slash command to the command group."""
        return self._prepend_power_command(CommandGroupConstants.POWEXEC_AUTO, power_string)
    
    def prepend_loc_self_power(self, power_string: str) -> '_CommandList':
        """Prepend a locational power on self as a slash command to the command group."""
        return self._prepend_power_command(CommandGroupConstants.POWEXEC_LOCATION, power_string, CommandGroupConstants.LOCATION_SELF)

    def prepend_loc_target_power(self, power_string: str) -> '_CommandList':
        """Prepend a locational power on target as a slash command to the command group."""
        return self._prepend_power_command(CommandGroupConstants.POWEXEC_LOCATION, power_string, CommandGroupConstants.LOCATION_TARGET)
    
    def prepend_loc_cursor_power(self, power_string: str) -> '_CommandList':
        """Prepend a locational power on cursor as a slash command to the command group."""
        return self._prepend_power_command(CommandGroupConstants.POWEXEC_LOCATION, power_string, CommandGroupConstants.LOCATION_CURSOR)

    def insert_power(self, index: int, power_string: str) -> '_CommandList':
        """Insert a power at a specific index in the command group."""
        return self._insert_power_command(index, CommandGroupConstants.POWEXEC_NAME, power_string)

    def insert_toggle_on_power(self, index: int, power_string: str) -> '_CommandList':
        """Insert a toggle on power at a specific index in the command group."""
        return self._insert_power_command(index, CommandGroupConstants.POWEXEC_TOGGLE_ON, power_string)

    def insert_toggle_off_power(self, index: int, power_string: str) -> '_CommandList':
        """Insert a toggle off power at a specific index in the command group."""
        return self._insert_power_command(index, CommandGroupConstants.POWEXEC_TOGGLE_OFF, power_string)

    def insert_auto_power(self, index: int, power_string: str) -> '_CommandList':
        """Insert an auto power at a specific index in the command group."""
        return self._insert_power_command(index, CommandGroupConstants.POWEXEC_AUTO, power_string)

    def insert_loc_self_power(self, index: int, power_string: str) -> '_CommandList':
        """Insert a locational power on self at a specific index in the command group."""
        return self._insert_power_command(index, CommandGroupConstants.POWEXEC_LOCATION, power_string, CommandGroupConstants.LOCATION_SELF)

    def insert_loc_target_power(self, index: int, power_string: str) -> '_CommandList':
        """Insert a locational power on target at a specific index in the command group."""
        return self._insert_power_command(index, CommandGroupConstants.POWEXEC_LOCATION, power_string, CommandGroupConstants.LOCATION_TARGET)

    def insert_loc_cursor_power(self, index: int, power_string: str) -> '_CommandList':
        """Insert a locational power on cursor at a specific index in the command group."""
        return self._insert_power_command(index, CommandGroupConstants.POWEXEC_LOCATION, power_string, CommandGroupConstants.LOCATION_CURSOR)

    def _add_power_command(self, powexec_type: str, power_string: str, location_arg: str = None) -> '_CommandList':
        """Helper function to add a power command to the command group."""
        command_string = self._build_power_command_string(powexec_type, power_string, location_arg)
        return self.add_command(command_string)
    
    def _prepend_power_command(self, powexec_type: str, power_string: str, location_arg: str = None) -> '_CommandList':
        """Helper function to prepend a power command to the command group."""
        command_string = self._build_power_command_string(powexec_type, power_string, location_arg)
        return self.prepend_command(command_string)

    def _insert_power_command(self, index: int, powexec_type: str, power_string: str, location_arg: str = None) -> '_CommandList':
    ...
    def _build_power_command_string(self, powexec_type: str, power_string: str, argument: str = None) -> str:
    ...
    def _add_movement_command(self, direction_string: str) -> '_CommandList':
        """Add a movement command to the command group."""
        command_string = self._build_movement_command_string(direction_string)
        return self.add_command(command_string)

    def _prepend_movement_command(self, direction_string: str) -> '_CommandList':
        """Prepend a movement command to the command group."""
        command_string = self._build_movement_command_string(direction_string)
        return self.prepend_command(command_string)
    
    def _insert_movement_command(self, index: int, direction_string: str) -> '_CommandList':
        """Insert a movement command at a specific index in the command group."""
        command_string = self._build_movement_command_string(direction_string)
        return self.insert_command(index, command_string)
    ...
    def add_bind_load(self) -> '_CommandList':
        """Add a bind load command as a slash command to the command group."""
        return self.add_command(CommandGroupConstants.BIND_LOAD)

    def add_bind_load_file(self, file_path: str) -> '_CommandList':
        """Add a bind load file command as a slash command to the command group."""
        return self._add_bind_file_command(CommandGroupConstants.BIND_LOAD_FILE, file_path)

    def add_bind_load_file_silent(self, file_path: str) -> '_CommandList':
        """Add a bind load file silent command as a slash command to the command group."""
        return self._add_bind_file_command(CommandGroupConstants.BIND_LOAD_FILE_SILENT, file_path)

    def add_bind_save(self) -> '_CommandList':
        """Add a bind save command as a slash command to the command group."""
        return self.add_command(CommandGroupConstants.BIND_SAVE)

    def add_bind_save_file(self, file_path: str) -> '_CommandList':
        """Add a bind save file command as a slash command to the command group."""
        return self._add_bind_file_command(CommandGroupConstants.BIND_SAVE_FILE, file_path)

    def add_bind_save_file_silent(self, file_path: str) -> '_CommandList':
        """Add a bind save file silent command as a slash command to the command group."""
        return self._add_bind_file_command(CommandGroupConstants.BIND_SAVE_FILE_SILENT, file_path)

    def prepend_bind_load(self) -> '_CommandList':
    ...
    def prepend_bind_load_file(self, file_path: str) -> '_CommandList':
        """Prepend a bind load file command as a slash command to the command group."""
        return self._prepend_bind_file_command(CommandGroupConstants.BIND_LOAD_FILE, file_path)
    
    def prepend_bind_load_file_silent(self, file_path: str) -> '_CommandList':
        """Prepend a bind load file silent command as a slash command to the command group."""
        return self._prepend_bind_file_command(CommandGroupConstants.BIND_LOAD_FILE_SILENT, file_path)
    
    def prepend_bind_save(self) -> '_CommandList':
    ...
    def prepend_bind_save_file(self, file_path: str) -> '_CommandList':
        """Prepend a bind save file command as a slash command to the command group."""
        return self._prepend_bind_file_command(CommandGroupConstants.BIND_SAVE_FILE, file_path)

    def prepend_bind_save_file_silent(self, file_path: str) -> '_CommandList':
        """Prepend a bind save file silent command as a slash command to the command group."""
        return self._prepend_bind_file_command(CommandGroupConstants.BIND_SAVE_FILE_SILENT, file_path)

    def insert_bind_load(self, index: int) -> '_CommandList':
    ...
    def insert_bind_load_file(self, index: int, file_path: str) -> '_CommandList':
        """Insert a bind load file command as a slash command to the command group."""
        return self._insert_bind_file_command(index, CommandGroupConstants.BIND_LOAD_FILE, file_path)

    def insert_bind_load_file_silent(self, index: int, file_path: str) -> '_CommandList':
        """Insert a bind load file silent command as a slash command to the command group."""
        return self._insert_bind_file_command(index, CommandGroupConstants.BIND_LOAD_FILE_SILENT, file_path)

    def insert_bind_save(self, index: int) -> '_CommandList':
    ...
    def insert_bind_save_file(self, index: int, file_path: str) -> '_CommandList':
        """Insert a bind save file command as a slash command to the command group."""
        return self._insert_bind_file_command(index, CommandGroupConstants.BIND_SAVE_FILE, file_path)

    def insert_bind_save_file_silent(self, index: int, file_path: str) -> '_CommandList':
        """Insert a bind save file silent command as a slash command to the command group."""
        return self._insert_bind_file_command(index, CommandGroupConstants.BIND_SAVE_FILE_SILENT, file_path)

    def _add_bind_file_command(self, bind_file_command: str, bind_file_path: str) -> '_CommandList':
        """Helper function to add a bind file command to the command group."""
        command_string = self._build_bind_file_command_string(bind_file_command, bind_file_path)
        return self.add_command(command_string)
    
    def _prepend_bind_file_command(self, bind_file_command: str, bind_file_path: str) -> '_CommandList':
        """Helper function to prepend a bind file command to the command group."""
        command_string = self._build_bind_file_command_string(bind_file_command, bind_file_path)
        return self.prepend_command(command_string)
    
    def _insert_bind_file_command(self, index: int, bind_file_command: str, bind_file_path: str) -> '_CommandList':
        """Helper function to insert a bind file command at a specific index in the command group."""
        command_string = self._build_bind_file_command_string(bind_file_command, bind_file_path)
        return self.insert_command(index, command_string)

    def _build_bind_file_command_string(self, bind_file_command: str, bind_file_path: str) -> str:
        return f"{bind_file_command} {bind_file_path}"

    # endregion

    def add_emote(self, emote_string: str) -> '_CommandList':
    ...
    def add_cc_emote(self, emote_string: str, cc_slot: int) -> '_CommandList':
    ...
    def __add__(self, other: '_CommandList') -> '_CommandList':
...
class CommandGroup(_CommandList):
    ...
    def __str__(self) -> str:
        ...
        return f"\"{self.COMMAND_DELIM.join(str(command) for command in self._commands)}\""
